...
input_root=/data/datasets/libero_agibotworld_format/test
save_root=/data/zhenyangfan/EVAC/logs/evac_libero_failure_2026-01-13T01-16-45/eval_results/10000/test
