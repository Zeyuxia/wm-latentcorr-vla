...
RUN_TAG="stage1_unified_failure_multitask_resume650_short_gpu01234567_${TIMESTAMP}"
...
SESSION="stage1_unified_resume650_short8"
...
note=short_resume_650_to700_on_8gpu_same_global_batch_single_rank_failure_prepare
INFO
...
WANDB_GROUP='stage1_unified_failure_multitask_resume650_short8' \
