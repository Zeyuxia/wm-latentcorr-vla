...
RESUME_CKPT=${RESUME_CKPT:-/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage2_from_unified_ep400_acthead_teachercorr_anchor_resume100_to200_free0123/20260401_151035/stage2_epoch_0200.pt}
RUN_ROOT=${RUN_ROOT:-/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage2_from_unified_ep400_acthead_teachercorr_anchor_resume200_to300_free0123}
RUN_TAG=${RUN_TAG:-stage2_from_unified_ep400_acthead_teachercorr_anchor_resume200_to300_free0123_$(date +"%Y%m%d_%H%M%S")}
...
TRAIN_SESSION=${TRAIN_SESSION:-stage2_from_unified_ep400_acthead_teachercorr_anchor_resume200_to300_free0123}
WATCH_SESSION=${WATCH_SESSION:-stage2_from_unified_ep400_acthead_teachercorr_anchor_resume200_to300_free0123_watch}
...
tmux new-session -d -s "${TRAIN_SESSION}" \
  "CUDA_VISIBLE_DEVICES=0,1,2,3 \
   ...
   WANDB_GROUP=stage2_from_unified_ep400_acthead_teachercorr_anchor_resume200_to300_free0123 \
...
CKPT_PATH=${TARGET_DIR}/stage2_epoch_0300.pt
