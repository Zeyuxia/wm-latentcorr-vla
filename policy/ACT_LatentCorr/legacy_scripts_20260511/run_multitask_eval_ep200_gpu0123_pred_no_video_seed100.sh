...
CKPT_DIR=/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage1_unified_failure_multitask/stage1_unified_failure_multitask_fulltable_lctok05_resume50_wandb_gpu0123_20260510_165353
CKPT=${CKPT_DIR}/stage1_unified_epoch_0200.pt
...
MASTER_TAG=${MASTER_TAG:-actmt200_gpu0123_pred_eval100_novideo_$(date +"%Y%m%d_%H%M%S")}
...
echo "[$(date '+%F %T')] all epoch200 multitask eval finished"
