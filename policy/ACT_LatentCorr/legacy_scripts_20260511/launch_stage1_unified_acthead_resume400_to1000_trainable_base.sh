...
RUN_TAG="stage1_unified_acthead_resume400_to1000_trainable_base_${TIMESTAMP}"
OUTPUT_ROOT="/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/unified_stage1_acthead_resume400_to1000_trainable_base"
...
SESSION_TRAIN="stage1_unified_acthead_resume400_to1000_trainable_base"
SESSION_WATCH="stage1_unified_acthead_resume400_to1000_trainable_base_watch"
SEED50="/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/jobs/seed_success_50.txt"
RESUME_CKPT="/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/unified_stage1_acthead_open1000_trainable_base/20260330_100537/stage1_epoch_0400.pt"
...
WANDB_GROUP='unified_stage1_acthead_resume400_to1000_trainable_base' \
...
echo '[watch] checkpoint ready, launching 50-seed base eval on 8 GPUs' | tee -a '${WATCH_LOG}' && \
LATENT_CKPT_PATH='${OUTPUT_DIR}/stage1_epoch_1000.pt' \
INFERENCE_MODE=base \
SEED_FILE='${SEED50}' \
GPU_LIST='0 1 2 3 4 5 6 7' \
RUN_TAG='${RUN_TAG}_eval50' \
CKPT_SETTING='${RUN_TAG}_eval50' \
