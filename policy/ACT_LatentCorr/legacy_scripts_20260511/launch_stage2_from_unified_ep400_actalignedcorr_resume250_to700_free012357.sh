...
RESUME_CKPT=${RESUME_CKPT:-/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage2_from_unified_ep400_actalignedcorr_resume50_to250_free01234567/20260405_235020/stage2_epoch_0250.pt}
RUN_ROOT=${RUN_ROOT:-/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage2_from_unified_ep400_actalignedcorr_resume250_to700_free012357}
RUN_TAG=${RUN_TAG:-stage2_from_unified_ep400_actalignedcorr_resume250_to700_free012357_$(date +"%Y%m%d_%H%M%S")}
...
tmux new-session -d -s "${TRAIN_SESSION}" \
  "CUDA_VISIBLE_DEVICES=0,1,2,3,5,7 \
   ...
   WANDB_GROUP=stage2_from_unified_ep400_actalignedcorr_resume250_to700_free012357 \
