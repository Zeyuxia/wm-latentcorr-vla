...
CKPT=/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage1_unified_failure_multitask/stage1_unified_failure_multitask_snapshot_gpu13_20260424_224247/stage1_unified_epoch_0150.pt
...
MASTER_TAG=actmt150_gpu13_eval30_$(date +"%Y%m%d_%H%M%S")
