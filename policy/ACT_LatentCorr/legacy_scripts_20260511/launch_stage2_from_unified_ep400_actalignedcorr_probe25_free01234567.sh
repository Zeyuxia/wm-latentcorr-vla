...
RUN_ROOT=${RUN_ROOT:-/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage2_from_unified_ep400_actalignedcorr_probe25_free01234567}
RUN_TAG=${RUN_TAG:-stage2_from_unified_ep400_actalignedcorr_probe25_free01234567_$(date +"%Y%m%d_%H%M%S")}
LOG_FILE=/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/logs/${RUN_TAG}.log
TRAIN_SESSION=${TRAIN_SESSION:-stage2_from_unified_ep400_actalignedcorr_probe25_free01234567}
...
tmux new-session -d -s "${TRAIN_SESSION}" \
  "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 \
   ...
   WANDB_GROUP=stage2_from_unified_ep400_actalignedcorr_probe25_free01234567 \
