...
RUN_TAG="stage1_unified_failure_multitask_final_rollout_resume150_gpu4567_${TIMESTAMP}"
...
SESSION="stage1_unified_final_rollout_resume150_gpu4567"

GPU_IDS="4,5,6,7"
RESUME_CKPT="/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage1_unified_failure_multitask/stage1_unified_failure_multitask_final_rollout_gpu4567_20260427_103554/stage1_unified_epoch_0150.pt"
...
tmux new-session -d -s "${SESSION}" "export OUTPUT_DIR='${OUTPUT_DIR}' LOG_FILE='${LOG_FILE}' RUN_TAG='${RUN_TAG}' RESUME_CKPT='${RESUME_CKPT}' FAILURE_TABLE_PATH='${FAILURE_TABLE_PATH}'; bash '${LOG_DIR}/run_train.sh'"
