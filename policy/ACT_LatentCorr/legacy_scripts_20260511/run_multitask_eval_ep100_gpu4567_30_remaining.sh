...
CKPT=/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage1_unified_failure_multitask/stage1_unified_failure_multitask_snapshot_gpu13_20260424_224247/stage1_unified_epoch_0100.pt
...
MASTER_TAG=actmt100_gpu4567_eval30_20260425_112659
...
echo "[resume $(date '+%F %T')] continue remaining tasks"
echo "ckpt=$CKPT"
...
echo "[$(date '+%F %T')] remaining epoch100 multitask eval finished"
