...
RUN_TAG="stage1_unified_acthead_open1000_trainable_base_${TIMESTAMP}"
OUTPUT_ROOT="/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/unified_stage1_acthead_open1000_trainable_base"
...
SESSION_TRAIN="stage1_unified_acthead_open1000_trainable_base"
SESSION_WATCH="stage1_unified_acthead_open1000_trainable_base_watch"
SEED50="/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/jobs/seed_success_50.txt"
ACT_INIT_CKPT="/data/zhenyangfan/RoboTwin/policy/ACT/act_ckpt/act-open_laptop/demo_clean-50/20260213_001933/policy_epoch_1000_seed_0.ckpt"
...
WANDB_GROUP='unified_stage1_acthead_open1000_trainable_base' \
