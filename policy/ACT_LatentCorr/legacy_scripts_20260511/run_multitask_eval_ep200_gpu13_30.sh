...
CKPT=/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage1_unified_failure_multitask/stage1_unified_failure_multitask_resume150_gpu4567_20260425_125258/stage1_unified_epoch_0200.pt
...
MASTER_TAG=actmt200_gpu13_eval30_$(date +"%Y%m%d_%H%M%S")
