...
CKPT=/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage1_unified_failure_multitask/stage1_unified_failure_multitask_resume150_gpu4567_20260425_125258/stage1_unified_epoch_0250.pt
...
MASTER_TAG=actmt250_gpu0123_eval30_$(date +"%Y%m%d_%H%M%S")
...
echo "[$(date '+%F %T')] all epoch250 multitask eval finished"
