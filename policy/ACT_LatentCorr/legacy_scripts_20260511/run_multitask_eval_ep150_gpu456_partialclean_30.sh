...
CKPT=/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage1_unified_failure_multitask/stage1_unified_failure_multitask_partialclean_gpu456_20260429_150605/stage1_unified_epoch_0150.pt
...
MASTER_TAG=actmt150_gpu456_eval30_partialclean_${INFERENCE_MODE}_$(date +"%Y%m%d_%H%M%S")
...
echo "[$(date '+%F %T')] all epoch150 multitask eval finished"
