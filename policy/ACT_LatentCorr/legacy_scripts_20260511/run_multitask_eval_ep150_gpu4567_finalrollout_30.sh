...
CKPT=/data/zhenyangfan/RoboTwin/policy/ACT_LatentCorr/outputs/formal_runs/stage1_unified_failure_multitask/stage1_unified_failure_multitask_final_rollout_gpu4567_20260427_103554/stage1_unified_epoch_0150.pt
...
MASTER_TAG=actmt150_gpu4567_eval30_finalrollout_$(date +"%Y%m%d_%H%M%S")
