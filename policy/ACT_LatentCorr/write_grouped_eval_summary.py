...
def main() -> None:
    ...
    parser.add_argument("--log-root", action="append", required=True, help="Repeat for each group log root")
    parser.add_argument(
        "--result-root",
        default="/data/zhenyangfan/RoboTwin/eval_result/open_laptop/ACT_LatentCorr/demo_clean",
    )
