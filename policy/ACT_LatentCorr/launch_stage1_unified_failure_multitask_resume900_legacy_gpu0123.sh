...
RUN_TAG="stage1_unified_failure_multitask_resume900_legacy_gpu0123_${TIMESTAMP}"
...
SESSION="stage1_unified_resume900_legacy_gpu0123"
...
use_wandb=false
note=legacy_launcher_style_resume900
INFO
...
WANDB_GROUP='stage1_unified_failure_multitask_resume900_legacy' \\
...
tmux new-session -d -s "${SESSION}" "bash '${LOG_DIR}/run_train.sh'"
