...
RUN_TAG="stage1_unified_failure_multitask_fulltable_lctok05_gpu0123_${TIMESTAMP}"
...
SESSION="stage1_unified_fulltable_lctok05_gpu0123"
...
note=clean_restart_from_act2000_with_new_evac_and_full_explore
INFO
