...
def eval_policy(
    ...
    for batch_ix in progbar:
        # Set init_state_id for each sub-environment based on batch index.
        # This ensures each episode uses a different init_state.
        # Formula per env: init_state_id = batch_ix * num_envs + episode_index
        if hasattr(env.unwrapped, 'envs') and hasattr(env.unwrapped.envs[0], 'set_batch_index'):
            env.call("set_batch_index", batch_ix, env.num_envs)
