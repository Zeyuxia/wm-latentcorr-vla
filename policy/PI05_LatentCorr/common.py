...
def ensure_norm_stats(
    ...
    *,
    ...
    try:
        ...
        print(f"[PI0_LatentCorr] norm stats already exist: {output_path}")
        return output_path
    except FileNotFoundError:
        pass

    output_path.parent.mkdir(parents=True, exist_ok=True)
    print(f"[PI0_LatentCorr] computing norm stats -> {output_path}")
    ...
    print(f"[PI0_LatentCorr] wrote norm stats: {output_path}")
    return output_path
